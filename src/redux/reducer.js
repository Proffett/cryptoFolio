...
export default function rootReducer(state = defaultState, action) {
    switch(action.type) {
        case FETCH_CRYPTO_DATA_PENDING: return {
            ...state,
            isLoading: true
        };
        case FETCH_CRYPTO_SUCCESS: return {
            ...state,
        ...
        case SET_CHART: return {
            ...state,
            times: action.payload.times,
            values: action.payload.values,
            isLoading: false,
        };
        case SET_COIN: return {
            ...state,
            chosenCoin: action.payload,
            isLoading: false,
        };
